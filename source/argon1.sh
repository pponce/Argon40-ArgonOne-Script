...
echo '			os.system("bash /home/pi/myscripts/multi_switch.sh --es-reboot")' >> $powerbuttonshutdownscript
echo '			#os.system("reboot")' >> $powerbuttonshutdownscript
echo '		elif pulsetime >=4 and pulsetime <=5:' >> $powerbuttonshutdownscript
echo '			os.system("bash /home/pi/myscripts/multi_switch.sh --es-poweroff")' >> $powerbuttonshutdownscript
